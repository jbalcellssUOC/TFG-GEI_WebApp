...
namespace Tests.ApiTests.Barcodes
{
    ...
    internal class UC6_UpdateDynamicBarcode : BaseTest
    {
        ...
        /********* UC6 **************************************************************/
        /****************************************************************************/
        //Use Case:         Authenticate User and Update Dynamic Barcode via Codis365 API
        //Use Case Name:    Authenticate User and Update Dynamic Barcode
        //Description:      This use case describes the steps required for a user to authenticate via the Codis365 API and subsequently update a dynamic barcode associated with their account.
        //Actors:
        ...
        //      The Codis365 API updates the dynamic barcode and returns its details to the authenticated user.
